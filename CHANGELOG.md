...
- Web run “afterglow” execution highlighting now persists longer (4s, up from 2.5s) and exec edges are rendered more prominently for better real-time workflow observability.
