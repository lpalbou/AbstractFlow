...
const CORE_NODES: NodeTemplate[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: 'guidance_2', label: 'guidance_2', type: 'number', description: 'Optional second-stage guidance for models that expose it.' },
      { id: 'count', label: 'count', type: 'number', description: 'Optional number of images to generate in one call.' },
      { id: 'seeds', label: 'seeds', type: 'array', description: 'Optional explicit batch seeds. When provided, their length defines the batch size unless count is also set.' },
      { id: 'lora_adapters', label: 'lora_adapters', type: 'array', description: 'Optional ordered LoRA adapter stack for compatible image models.' },
    ...
    outputs: [
      ...
      { id: 'image_artifacts', label: 'image_artifacts', type: 'artifacts_image', description: 'Ordered artifact refs for batched image generation.' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { id: 'guidance_scale', label: 'guidance', type: 'number' },
      { id: 'guidance_2', label: 'guidance_2', type: 'number', description: 'Optional second-stage guidance for models that expose it.' },
      { id: 'count', label: 'count', type: 'number', description: 'Optional number of edited images to generate in one call.' },
      { id: 'seeds', label: 'seeds', type: 'array', description: 'Optional explicit batch seeds. When provided, their length defines the batch size unless count is also set.' },
      { id: 'lora_adapters', label: 'lora_adapters', type: 'array', description: 'Optional ordered LoRA adapter stack for compatible image-edit models.' },
    ...
    outputs: [
      ...
      { id: 'image_artifacts', label: 'image_artifacts', type: 'artifacts_image', description: 'Ordered artifact refs for batched image editing.' },
      { id: 'artifact_ref', label: 'artifact_ref', type: 'artifact' },
      { id: 'artifact_id', label: 'artifact_id', type: 'string' },
      { id: 'content_type', label: 'content_type', type: 'string' },
      { id: 'outputs', label: 'outputs', type: 'object' },
  ...
  },
  {
    ...
    description: 'Generate a video through Gateway vision capability and return a video artifact.',
    headerColor: '#0EA5A4',
    gatewayCapability: NODE_GATEWAY_CAPABILITIES.generate_video,
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'prompt', label: 'prompt', type: 'string', description: 'Video prompt.' },
      { id: 'video_provider', label: 'provider', type: 'provider_video', description: 'Optional video provider/backend.' },
      { id: 'video_model', label: 'model', type: 'model', description: 'Optional video model id for the selected video provider.' },
      { id: 'width', label: 'width', type: 'number' },
      { id: 'height', label: 'height', type: 'number' },
      { id: 'frames', label: 'frames', type: 'number' },
      { id: 'fps', label: 'fps', type: 'number' },
      { id: 'format', label: 'format', type: 'string', description: 'mp4, mov, or gif.' },
      { id: 'seed', label: 'seed', type: 'number' },
      { id: 'steps', label: 'steps', type: 'number' },
      { id: 'guidance_scale', label: 'guidance', type: 'number' },
      { id: 'guidance_2', label: 'guidance_2', type: 'number', description: 'Optional second-stage guidance for dual-transformer video models.' },
      { id: 'count', label: 'count', type: 'number', description: 'Optional number of videos to generate in one call.' },
      { id: 'seeds', label: 'seeds', type: 'array', description: 'Optional explicit batch seeds. When provided, their length defines the batch size unless count is also set.' },
      { id: 'flow_shift', label: 'flow_shift', type: 'number', description: 'Optional flow-shift control for compatible video models.' },
      { id: 'lora_adapters', label: 'lora_adapters', type: 'array', description: 'Optional ordered LoRA adapter stack for compatible video models.' },
      { id: 'negative_prompt', label: 'negative', type: 'string' },
      { id: 'extra', label: 'extra', type: 'object', description: 'Optional provider-specific video-generation options.' },
    ],
    outputs: [
      { id: 'exec-out', label: '', type: 'execution' },
      { id: 'video_artifact', label: 'video_artifact', type: 'artifact_video', description: 'Artifact ref for the generated video.' },
      { id: 'video_artifacts', label: 'video_artifacts', type: 'artifacts_video', description: 'Ordered artifact refs for batched video generation.' },
      { id: 'artifact_ref', label: 'artifact_ref', type: 'artifact' },
      { id: 'artifact_id', label: 'artifact_id', type: 'string' },
      { id: 'content_type', label: 'content_type', type: 'string' },
      { id: 'outputs', label: 'outputs', type: 'object' },
  ...
  },
  {
    ...
    icon: '&#x1F3AC;',
    label: 'Text To Video',
    description: 'Compatibility alias for Generate Video.',
    headerColor: '#0EA5A4',
    gatewayCapability: NODE_GATEWAY_CAPABILITIES.text_to_video,
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'prompt', label: 'prompt', type: 'string' },
      { id: 'video_provider', label: 'provider', type: 'provider_video' },
      { id: 'video_model', label: 'model', type: 'model' },
      { id: 'frames', label: 'frames', type: 'number' },
      { id: 'fps', label: 'fps', type: 'number' },
      { id: 'format', label: 'format', type: 'string' },
      { id: 'seed', label: 'seed', type: 'number' },
    ...
    outputs: [
      { id: 'exec-out', label: '', type: 'execution' },
      { id: 'video_artifact', label: 'video_artifact', type: 'artifact_video' },
      { id: 'video_artifacts', label: 'video_artifacts', type: 'artifacts_video', description: 'Ordered artifact refs for batched video generation.' },
      { id: 'artifact_ref', label: 'artifact_ref', type: 'artifact' },
      { id: 'artifact_id', label: 'artifact_id', type: 'string' },
      { id: 'content_type', label: 'content_type', type: 'string' },
  ...
  },
  {
    ...
    description: 'Animate an input image through Gateway image-to-video capability and return a video artifact.',
    headerColor: '#0EA5A4',
    gatewayCapability: NODE_GATEWAY_CAPABILITIES.image_to_video,
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'prompt', label: 'prompt', type: 'string', description: 'Instruction for the image-to-video generation.' },
      { id: 'source_image', label: 'source_image', type: 'artifact_image', description: 'Source image artifact ref.' },
      { id: 'video_provider', label: 'provider', type: 'provider_video', description: 'Optional image-to-video provider/backend.' },
      { id: 'video_model', label: 'model', type: 'model', description: 'Optional image-to-video model id for the selected provider.' },
      { id: 'width', label: 'width', type: 'number' },
      { id: 'height', label: 'height', type: 'number' },
      { id: 'frames', label: 'frames', type: 'number' },
      { id: 'fps', label: 'fps', type: 'number' },
      ...
      { id: 'flow_shift', label: 'flow_shift', type: 'number', description: 'Optional flow-shift control for compatible video models.' },
      { id: 'lora_adapters', label: 'lora_adapters', type: 'array', description: 'Optional ordered LoRA adapter stack for compatible video models.' },
      { id: 'strength', label: 'strength', type: 'number', description: 'Optional conditioning strength for image-to-video backends.' },
      { id: 'negative_prompt', label: 'negative', type: 'string' },
      { id: 'extra', label: 'extra', type: 'object', description: 'Optional provider-specific image-to-video options.' },
    ],
    outputs: [
      { id: 'exec-out', label: '', type: 'execution' },
      { id: 'video_artifact', label: 'video_artifact', type: 'artifact_video', description: 'Artifact ref for the generated video.' },
      { id: 'video_artifacts', label: 'video_artifacts', type: 'artifacts_video', description: 'Ordered artifact refs for batched image-to-video generation.' },
      { id: 'artifact_ref', label: 'artifact_ref', type: 'artifact' },
      { id: 'artifact_id', label: 'artifact_id', type: 'string' },
      { id: 'content_type', label: 'content_type', type: 'string' },
      { id: 'outputs', label: 'outputs', type: 'object' },
  ...
  },
  {
    ...
    icon: '&#x1F3A4;',
    label: 'Listen Voice',
    description: 'Pause the workflow and ask the host UI to capture a voice/audio response.',
    headerColor: '#0EA5A4',
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'prompt', label: 'prompt', type: 'string' },
...
const ARTIFACT_LITERAL_NODES: NodeTemplate[] = [
  {
    ...
    icon: '&#x1F4CE;',
    label: 'Artifact',
    description: 'Saved artifact reference object for any runtime-owned file or payload. Use this with Read Artifact or artifact-aware media/file nodes.',
    headerColor: '#5EEAD4',
    inputs: [],
    outputs: [{ id: 'value', label: 'artifact', type: 'artifact' }],
    category: 'artifacts',
  },
  {
    type: 'literal_json',
    icon: '&#x1F4DD;',
    label: 'Text Artifact',
    description: 'Saved artifact reference object for a text/plain artifact. Paste an uploaded, imported, or generated artifact id into $artifact.',
    headerColor: '#64748B',
    inputs: [],
  ...
  },
  {
    ...
    description: 'Saved artifact reference object for an image artifact. Wire this into Edit Image image_artifact or mask_artifact.',
    headerColor: '#19D3B8',
    inputs: [],
  ...
  },
  {
    ...
    description: 'Saved artifact reference object for a speech/audio artifact.',
    headerColor: '#22D3EE',
    inputs: [],
  ...
  },
  {
    ...
    description: 'Saved artifact reference object for a music/audio artifact.',
    headerColor: '#F59E0B',
    inputs: [],
  ...
  },
  {
    ...
    description: 'Saved artifact reference object for a video artifact.',
    headerColor: '#A855F7',
    inputs: [],
...
const MEMORY_NODES: NodeTemplate[] = [
  {
    ...
    icon: '&#x1F4C4;', // Page facing up
    label: 'Read File',
    description: 'Read a workspace-scoped server file path and output UTF-8 text or JSON content. In Gateway-hosted runs, access stays within the allowed workspace policy.',
  ...
  },
  {
    ...
    icon: '&#x1F4BE;', // Floppy disk
    label: 'Write File',
    description: 'Write content to a workspace-scoped server file path (creates parent folders if needed). In local Runtime-only runs without workspace scope, relative paths fall back to the process working directory.',
    headerColor: '#16A085', // Teal - IO
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'file_path', label: 'file_path', type: 'workspace_file' },
  ...
  },
  {
    ...
    icon: '&#x1F4D6;', // Open book
    label: 'Read PDF',
    description: 'Extract text and metadata from a workspace-scoped server PDF path using the Runtime permissive PDF reader.',
    headerColor: '#16A085', // Teal - IO
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'file_path', label: 'file_path', type: 'workspace_file' },
  ...
  },
  {
    ...
    description: 'List files inside a workspace-scoped server folder, with optional family and extension filters.',
    headerColor: '#16A085',
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'folder_path', label: 'folder_path', type: 'workspace_folder' },
      { id: 'recursive', label: 'recursive', type: 'boolean', description: 'When true, recurse into subfolders.' },
      { id: 'family', label: 'family', type: 'string', description: 'Optional family filter: any | image | video | audio | document | text | code | json | archive | other.' },
      { id: 'extensions', label: 'extensions', type: 'array', description: 'Optional list of file extensions without dots.' },
      { id: 'include_directories', label: 'include_directories', type: 'boolean', description: 'When true, include folder entries in the structured results.' },
      { id: 'limit', label: 'limit', type: 'number', description: 'Maximum number of returned entries. Default: 500.' },
      { id: 'max_depth', label: 'max_depth', type: 'number', description: 'Optional recursive depth limit. Use 0 for unlimited depth.' },
    ],
    outputs: [
      { id: 'exec-out', label: '', type: 'execution' },
      { id: 'folder_path', label: 'folder_path', type: 'workspace_folder' },
  ...
  },
  {
    ...
    icon: '&#x2B07;',
    label: 'Import Server File',
    description: 'Snapshot a workspace-scoped server file into a runtime-owned Artifact for reuse across downstream steps and future runs.',
    headerColor: '#16A085',
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'file_path', label: 'file_path', type: 'workspace_file' },
      { id: 'content_type', label: 'content_type', type: 'string', description: 'Optional MIME override when the filename extension is misleading.' },
    ],
    outputs: [
      { id: 'exec-out', label: '', type: 'execution' },
  ...
  },
  {
    ...
    icon: '&#x1F4C2;',
    label: 'Read Artifact',
    description: 'Read any Artifact payload and expose bounded text, JSON, or base64 projections plus content metadata.',
    headerColor: '#16A085',
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'artifact', label: 'artifact', type: 'artifact' },
    ...
    outputs: [
      ...
      { id: 'artifact_id', label: 'artifact_id', type: 'string' },
      { id: 'content_type', label: 'content_type', type: 'string' },
      { id: 'content_family', label: 'content_family', type: 'string' },
      { id: 'size_bytes', label: 'size_bytes', type: 'number' },
      { id: 'filename', label: 'filename', type: 'string' },
      { id: 'source_path', label: 'source_path', type: 'string' },
      { id: 'content', label: 'content', type: 'any' },
      { id: 'text', label: 'text', type: 'string' },
      { id: 'json', label: 'json', type: 'object' },
      { id: 'binary_base64', label: 'binary_base64', type: 'string' },
      { id: 'is_binary', label: 'is_binary', type: 'boolean' },
      { id: 'warnings', label: 'warnings', type: 'array' },
      { id: 'truncated', label: 'truncated', type: 'boolean' },
    ],
    category: 'memory',
  },
  {
    ...
    description: 'Write an Artifact payload to a workspace-scoped server file path.',
    headerColor: '#16A085',
    inputs: [
      { id: 'exec-in', label: '', type: 'execution' },
      { id: 'artifact', label: 'artifact', type: 'artifact' },
...
export function mergePinDocsFromTemplate(
  ...
  const normalizeRetiredMediaDefaults = (data: FlowNodeData): FlowNodeData => {
    ...
    let changed = false;
    const hasExplicitImageRoute = (...keys: string[]): boolean =>
      keys.some((key) => typeof pinDefaults[key] === 'string' && String(pinDefaults[key]).trim().length > 0);
    ...
    if (
      ...
      pinDefaults.width === 512 &&
      pinDefaults.height === 512 &&
      !hasExplicitImageRoute('image_provider', 'imageProvider', 'provider', 'image_model', 'imageModel', 'model')
    ) {
      delete pinDefaults.width;
      delete pinDefaults.height;
      changed = true;
    }
