...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Image Artifact"}`
...
- Authorable config: select with `templateLabel: "Image Artifact"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Music Artifact"}`
- Utility: Artifact reference object for a music/audio Gateway artifact.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Music Artifact"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Text Artifact"}`
...
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Text Artifact"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Video Artifact"}`
- Utility: Artifact reference object for a video Gateway artifact.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Video Artifact"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Voice Artifact"}`
- Utility: Artifact reference object for a speech/audio Gateway artifact.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Voice Artifact"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `and`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"and"}`
- Utility: Logical AND.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`
...
- Node type: `compare`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"compare"}`
...
- Node type: `for`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"for"}`
...
- Node type: `if`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"if"}`
...
- Node type: `loop`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"loop"}`
...
- Node type: `not`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"not"}`
- Utility: Logical NOT.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`
...
- Node type: `or`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"or"}`
- Utility: Logical OR.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`
...
- Node type: `parallel`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"parallel"}`
- Utility: Run multiple branches concurrently and emit Completed when all finish.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; branch count with `set_branch_count`
...
- Node type: `sequence`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"sequence"}`
...
- Node type: `switch`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"switch"}`
- Utility: Branch execution by matching a string value to configured cases (default branch always exists).
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; cases with `set_switch_cases`
...
- Node type: `while`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"while"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"add_message"}`
...
- Node type: `agent`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"agent"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"answer_user"}`
...
- Node type: `ask_user`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"ask_user"}`
...
- Node type: `code`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"code"}`
- Utility: Run a Python transform body as `transform(_input)` in the Runtime sandbox.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; body/function with `set_code_body`; permissions must remain `sandbox`
...
- Node type: `llm_call`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"llm_call"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"model_residency"}`
...
- Node type: `subflow`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"subflow"}`
- Utility: Run another saved workflow (subflow) and return its output object.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; subflow id is UI-owned; do not create an unconfigured subflow as a finished workflow
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"tool_calls","pinDefaults":{"allowed_tools":["<exact_tool_name>"]}}`
...
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; must include `pinDefaults.allowed_tools` in `add_node`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"agent_trace_report"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_append"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_concat"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_dedup"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_filter"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_length"}`
...
- Node type: `array_map`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"array_map"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"break_object"}`
- Utility: Expose selected fields of an object as individual output pins (configured paths).
- Gateway capability: none
- Dynamic pin policy: dynamic outputs via set_break_paths or add_output_pin; both update selectedPaths
- Authorable config: input defaults with `set_pin_default`; selected paths with `set_break_paths`
...
- Node type: `coalesce`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"coalesce"}`
...
- Node type: `concat`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"concat"}`
- Utility: Concatenate two strings.
- Gateway capability: none
- Dynamic pin policy: dynamic inputs
- Authorable config: input defaults with `set_pin_default`; separator with `set_concat_separator`
...
- Node type: `contains`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"contains"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"format_tool_results"}`
...
- Node type: `format`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"format"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"get_element"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"get_random_element"}`
...
- Node type: `get`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"get"}`
...
- Node type: `has_tools`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"has_tools"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"is_empty_string"}`
...
- Node type: `join`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"join"}`
...
- Node type: `length`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"length"}`
...
- Node type: `lowercase`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"lowercase"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"make_array"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"make_context"}`
...
- Node type: `make_meta`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"make_meta"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"make_object"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"make_scratchpad"}`
...
- Node type: `merge`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"merge"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"parse_json"}`
...
- Node type: `replace`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"replace"}`
...
- Node type: `set`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"set"}`
...
- Node type: `split`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"split"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"string_template"}`
- Utility: Render a template like "Hello {{user.name}}" using a vars object (supports filters).
- Gateway capability: none
- Dynamic pin policy: dynamic inputs
- Authorable config: input defaults with `set_pin_default`; template with `set_literal` or `set_pin_default(template)`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"stringify_json"}`
...
- Node type: `substring`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"substring"}`
...
- Node type: `trim`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"trim"}`
...
- Node type: `uppercase`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"uppercase"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"emit_event"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_agent_message"}`
- Utility: Entry point triggered by an agent-to-agent message (broadcast or direct).
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: event settings with `set_event_config`
- Inputs: none
...
- Node type: `on_event`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_event"}`
- Utility: Entry point triggered by a durable custom event. Outputs event metadata + payload.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; event settings with `set_event_config`
- Inputs: `scope` string
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_flow_end"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_flow_start"}`
- Utility: Entry point for a workflow run. Emits exec-out and any configured inputs as outputs.
- Gateway capability: none
- Dynamic pin policy: dynamic outputs
- Authorable config: no node-specific command config beyond pins/defaults
- Inputs: none
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_schedule"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"on_user_request"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"system_datetime"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"wait_event"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"wait_until"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"json_schema"}`
- Utility: Define a JSON Schema object for schema-constrained responses. Connect to `resp_schema` on LLM Call / Agent nodes.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_array","templateLabel":"Array"}`
- Utility: Array literal value.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Array"`; literal value with `literalValue` or `set_literal`
- Inputs: none
- Outputs: `value` array
- Default config: none
...
- Node type: `literal_array`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_array","templateLabel":"Assertions"}`
- Utility: KG assertion list literal value (assertion[]).
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Assertions"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_boolean"}`
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Assertion"}`
- Utility: KG assertion literal value (subject/predicate/object + optional metadata).
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Assertion"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"JSON"}`
- Utility: Object (JSON) literal value.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "JSON"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Node type: `literal_json`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_json","templateLabel":"Memory"}`
- Utility: Memory configuration object for Agent/LLM Call recall and KG settings.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: select with `templateLabel: "Memory"`; literal value with `literalValue` or `set_literal`
- Inputs: none
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_number"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"literal_string"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"provider_catalog"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"provider_models"}`
- Utility: List models for a provider. Optionally restrict the list by capability route and selected allowed models.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; provider models config is UI-owned; use provider/capability pins when possible
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"tool_parameters"}`
- Utility: Pick a tool and set its arguments (typed + defaults). Outputs a tool call object for Tool Calls.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: tool and argument pins with `set_tool_parameters`
- Inputs: none
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"tools_allowlist"}`
- Utility: Select an allowlist of tool names once and reuse it across LLM/Agent/Tool Calls nodes.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: tool names with `set_literal`
- Inputs: none
- Outputs: `tools` tools
- Default config: none
...
- Node type: `abs`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"abs"}`
...
- Node type: `add`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"add"}`
...
- Node type: `divide`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"divide"}`
...
- Node type: `modulo`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"modulo"}`
...
- Node type: `multiply`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"multiply"}`
...
- Node type: `power`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"power"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"random_float"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"random_int"}`
...
- Node type: `round`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"round"}`
...
- Node type: `subtract`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"subtract"}`
- Utility: Compute a - b.
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"edit_image"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"generate_image"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"generate_music"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"generate_video"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"generate_voice"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"image_to_video"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"listen_voice"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"transcribe_audio"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"upscale_image"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memact_compose"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_compact"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_kg_assert"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_kg_query"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_kg_resolve"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_note"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_query"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_rehydrate"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"memory_tag"}`
...
- Node type: `read_file`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"read_file"}`
...
- Node type: `read_pdf`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"read_pdf"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"write_file"}`
...
- Node type: `write_pdf`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"write_pdf"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"edit_json_schema"}`
...
- Gateway capability: none
- Dynamic pin policy: template pins only
- Authorable config: input defaults with `set_pin_default`; literal value with `literalValue` or `set_literal`
...
- Node type: `bool_var`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"bool_var"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"get_context"}`
...
- Node type: `get_var`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"get_var"}`
...
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"set_var_property"}`
...
- Node type: `set_var`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"set_var"}`
...
- Node type: `set_vars`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"set_vars"}`
...
- Node type: `var_decl`
- Create command: `{"action":"add_node","id":"<unique_id>","nodeType":"var_decl"}`
...
- `call_tool` / Call Tool: rejected by `add_node` (hidden, deprecated).
- `image_to_image` / Image To Image: rejected by `add_node` (hidden).
- `text_to_video` / Text To Video: rejected by `add_node` (hidden).
